...
| `verify-teleporter-scene-fields` | `create-teleporter` / `remap-teleporters` and the scene fields they read |
...
| `verify-region-tooling` | `create-region` / `add-region-behavior` / `update-region` |
