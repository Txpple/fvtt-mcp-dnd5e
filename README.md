...
- **`FOUNDRY_TOOLSETS`** — a registration advertises a subset of the 115 tools (14 named toolsets;
...
The full surface is 115 tools, and `tools/list` for it is ~57k tokens. A client that loads MCP
...
**115 tools total: 105 over the headless bridge (Plane A) + 10 asset file tools over the host's file plane (Plane B).**
